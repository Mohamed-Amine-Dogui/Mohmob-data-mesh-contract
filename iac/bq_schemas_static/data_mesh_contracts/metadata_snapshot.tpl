[
    ...
    {
    "descriptions": "The domain of team responsible for the overall management, quality, SLAs, monitoring and delivery of a specific data product.",
    "mode": "NULLABLE",
    "name": "dp_owner_dataDomain",
    "type": "STRING"
    },
    {
    "descriptions": "The contact of team responsible for the overall management, quality, SLAs, monitoring and delivery of a specific data product.",
    "mode": "NULLABLE",
